  ...
  yourNeed: [
    {
      _id: '1',
      name: 'Đơn giản',
      image: require('./img/YourNeed/1.png')
    },

    {
      _id: '2',
      name: 'Hiện đại',
      image: require('./img/YourNeed/2.png')
    },

    {
      _id: '3',
      name: 'Cao cấp',
      image: require('./img/YourNeed/3.png')
    },

    {
      _id: '4',
      name: 'Phân phối độc quyền',
      image: require('./img/YourNeed/4.png')
    },

    {
      _id: '5',
      name: 'Limited Edition',
      image: require('./img/YourNeed/5.png')
    }
  ]
}
