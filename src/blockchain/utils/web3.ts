...
import { RPC } from 'src/blockchain/constants/rpc';
import { WS } from 'src/blockchain/constants/wsProvider';
export class Web3 {
  ...
  static wsProvider(chainId: number) {
    ...
    return new web3(new web3.providers.WebsocketProvider(WS[chainId], options));
  }
